...
library(rmarkdown)
library(readr)
#Leemos los archivos descargados en excel y creamos las variables para la cantidad de aC1os y el pais
...
#Ahora unimos ambos dataframes en 1, por su aC1o y pais, y lo guardamos en una nueva dataframe
...
#Realizamos la comparacion entre las emisiones de CO2 y el Nuclear Share de ambos paises
